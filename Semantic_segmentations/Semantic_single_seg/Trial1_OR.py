...
model.save('/root/project/code/kits/model/Trial_1_OR.h5')
print('###### MODEL SAVED ######')

hist_df = pd.DataFrame(history.history) 
hist_csv_file = '/root/project/code/kits/model/Trial_1_OR.csv'
